		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomgestaofioriappadmin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappadmin-display": {
								"semanticObject": "brcomgestaofioriappadmin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappadminusers",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappadminusers")
								}
							}
						}
					}
